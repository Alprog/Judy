...
void Meta::defineClasses()
{
    ...
    ClassDefiner<VirtualDevice>(this, "VirtualDevice")
        .base<Object>()
        .constructor()
        .method("addKeySource", &VirtualDevice::addKeySource)
        .method("isPressed", &VirtualDevice::isPressed)
        .method("isReleased", &VirtualDevice::isReleased)
        .method("wasPressed", &VirtualDevice::wasPressed)
        .method("wasReleased", &VirtualDevice::wasReleased)
        .method("onPressed", &VirtualDevice::onPressed)
        .method("onReleased", &VirtualDevice::onReleased)
    ...
    ClassDefiner<Vector2>(this, "Vector2")
        ...
        .field("x", &Vector2::x).attr("Inspect")
        .field("y", &Vector2::y).attr("Inspect")
    ;
    ...
    ClassDefiner<Vector3>(this, "Vector3")
        ...
        .field("x", &Vector3::x).attr("Inspect")
        .field("y", &Vector3::y).attr("Inspect")
        .field("z", &Vector3::z).attr("Inspect")
    ;
    ...
    ClassDefiner<Vector4>(this, "Vector4")
        ...
        .field("x", &Vector4::x).attr("Inspect")
        .field("y", &Vector4::y).attr("Inspect")
        .field("z", &Vector4::z).attr("Inspect")
    ...
    ClassDefiner<Window>(this, "Window")
        ...
        .field("renderer", &Window::renderer)
    ;
}
