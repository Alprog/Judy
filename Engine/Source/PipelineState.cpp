...
PipelineState::PipelineState(Shader* vertexShader, Shader* pixelShader, DXRenderer* renderer)
{
    ...
    psoDesc.VS = CD3DX12_SHADER_BYTECODE(static_cast<DXShader*>(vertexShader)->blob.Get());
    psoDesc.PS = CD3DX12_SHADER_BYTECODE(static_cast<DXShader*>(pixelShader)->blob.Get());
